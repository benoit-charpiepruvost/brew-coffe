...
import net.charpiepruvost.brewcoffee.BrewCoffeApp;
import net.charpiepruvost.brewcoffee.domain.Authority;
import net.charpiepruvost.brewcoffee.domain.User;
import net.charpiepruvost.brewcoffee.repository.AuthorityRepository;
import net.charpiepruvost.brewcoffee.repository.UserRepository;
import net.charpiepruvost.brewcoffee.security.AuthoritiesConstants;
...
@SpringBootTest(classes = BrewCoffeApp.class)
